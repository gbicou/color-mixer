...
class Reflectance
{
     ...
     * @var float[]
     */
    const array XYZ_R = [  3.2409699419045226,  -1.537383177570094,   -0.4986107602930034  ];
    /**
     * @var float[]
     */
    const array XYZ_G = [ -0.9692436362808796,   1.8759675015077202,   0.04155505740717559 ];
    /**
     * @var float[]
     */
    ...
    private function calculate(ColorInterface $color)
    {
